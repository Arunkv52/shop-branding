      ...
      <div className='md:py-50 py-10 bg-black' id='services'>
        ...
        <div className='ser-box md:flex justify-content-between align-top gap-5 md:px-20 px-5'>
          <h2 className='text-white md:text-3xl text-[24px] md:py-0 py-10'>
            At Prism Adverto,  <span className='text-white/60'>we don’t stop at In shop branding.</span> We help your brand
            reach audiences everywhere—through theater advertising, Hoarding, wall wrapping, stall fabrication for events and Van Campaigns . Whether
